...
const SLIDES: Slide[] = [
  {
    ...
    desc: "HOS, location, load type, customer history, lane familiarity. Enrout Ops ranks every available driver against every open load — you make the call, or let it auto-assign.",
  },
  {
    id: "etas",
    ...
    desc: "Traffic, weather, driver patterns, customer dwell time — Enrout Ops forecasts ETAs and flags risk while there's still time to act.",
  },
];
