          ...
          <nav className="hidden md:flex gap-1" aria-label="Primary">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="font-mono text-[12.5px] tracking-[0.02em] text-ink-2 font-medium px-2.5 py-1.5 rounded-md whitespace-nowrap transition-colors duration-150 hover:text-ink hover:bg-bg-soft group"
              >
                <span className="text-ink-4 mr-0.5 transition-colors duration-150 group-hover:text-sds-accent">
                  [
                </span>
                {" "}{link.label}{" "}
                <span className="text-ink-4 ml-0.5 transition-colors duration-150 group-hover:text-sds-accent">
                  ]
                </span>
              </a>
            ))}
